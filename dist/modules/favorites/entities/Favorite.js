...
const User_1 = require("../../auth/entities/User");
const Restaurant_1 = require("../../restaurants/entities/Restaurant");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => User_1.User, (user) => user.favorites, { onDelete: "CASCADE" }),
    __metadata("design:type", User_1.User)
], Favorite.prototype, "user", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => Restaurant_1.Restaurant, (restaurant) => restaurant.favorites, { onDelete: "CASCADE" }),
